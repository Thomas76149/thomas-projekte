...
window.THOMASFUN_ITEMS = [
  ...
  { title:"Panzer", href:"spiele/tanks/index.html", emoji:"🛞", label:"Online · Top‑Down", desc:"Bis 4 Spieler, Ready-Lobby, dann Live-Kampf: Labyrinth, abprallende Kugeln, Powerups.", tags:["game","arcade","online","multiplayer"], section:"online" },
  { title:"Trivia", href:"spiele/trivia/index.html", emoji:"🧠", label:"Online · Quiz", desc:"Bis 8 Spieler: Kategorien inkl. Militär/WW2, Schwierigkeit, viele Fragen ohne Wiederholung pro Durchlauf — Room wie Panzer.", tags:["game","quiz","online","multiplayer","military"], section:"online" },
