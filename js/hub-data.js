...
window.THOMASFUN_ITEMS = [
  ...
  { title:"BlockBlast", href:"spiele/blockblast/index.html", emoji:"🧱", label:"Puzzle · Blocks", desc:"3 Blöcke unten, platzieren, Reihen/Spalten clearen, Highscore jagen.", tags:["game","puzzle","blocks","mobile","canvas"], section:"games" },
  ...
  { title:"Stein‑Schere‑Papier", href:"spiele/rps/index.html", emoji:"🪨", label:"Online · Mini", desc:"Online (Room‑Code) oder lokal Streak jagen — mit Partikeln, Sound und Vibration.", tags:["game","mini","mobile","online"], section:"online" },
  ...
  { title:"Game of Life", href:"spiele/game-of-life/index.html", emoji:"🦠", label:"Simulation · Unendlich", desc:"Conways berühmter Zellulärer Automat auf einem unendlichen, scrollbaren Feld: Linksklick setzt, Rechtsklick löscht, Presets wie Gleiter, Pulsar oder die Gleiter‑Kanone platzieren — flüssig dank Sparse‑Engine. Sieh zu, wie aus 3 simplen Regeln komplexes Leben entsteht.", tags:["tool","test","sim","canvas","mobile"], section:"tests" },
  { title:"Particle Life", href:"spiele/particle-life/index.html", emoji:"⚛️", label:"Simulation · Emergenz", desc:"Bunte Partikel ziehen sich an und stoßen sich ab — du stellst pro Farbpaar ein, wie stark. Aus diesen simplen Kräften entstehen ganz von selbst Zellen, Würmer und Jäger‑Beute‑Muster. Editierbare Reaktions‑Matrix, performant für tausende Partikel dank Spatial‑Grid.", tags:["tool","test","sim","canvas","mobile"], section:"tests" },
];
