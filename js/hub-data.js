...
window.THOMASFUN_ITEMS = [
  ...
  { title:"Pong", href:"spiele/pong/index.html", emoji:"🏓", label:"Online · Arcade", desc:"Online (Room‑Code) oder lokal gegen Bot — mit Sparks, Sound & FX.", tags:["game","arcade","online"], section:"online" },
  { title:"Panzer", href:"spiele/tanks/index.html", emoji:"🛞", label:"Online · Top‑Down", desc:"Bis 4 Spieler: Labyrinth‑Map, Kugeln prallen ab, Powerups (Tempo, Schnellfeuer, Heilung, Schild).", tags:["game","arcade","online","multiplayer"], section:"online" },
